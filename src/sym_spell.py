...
class AutoCorrect():
    ...
    def __init__(self, max_edit_distance_dictionary = 2, prefix_length = 7):
        self.predictor = self.create_sym_spell(max_edit_distance_dictionary, prefix_length)
...
def main():
    ...
    # create object
    ao = AutoCorrect()
    sym_spell = ao.create_sym_spell(max_edit_distance_dictionary, prefix_length)
