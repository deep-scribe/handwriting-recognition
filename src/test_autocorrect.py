...
def test_trajectory(predictor, kernel_func):
    ...
    for pred in predictions:
        ...
        prob, final_word = summerize_score(
            predictor, kernel_func, confidence_map)
...
def performance_test():
    ...
    print("Time for correcting one word:", timeit.timeit(
        __predict_words_test, number=1) / 65.0)
...
if __name__ == "__main__":
    ...
    print("Accuracy with hard freq edit_distance:",
          test_trajectory(predictor, hard_freq_dist))
