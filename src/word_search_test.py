...
MODEL_WEIGHT_PATH = '../saved_model/rnn_final/rnn_final_random_resampled_14.pth'
...
if __name__ == "__main__":
    ...
    # word_df = data_utils.load_subject('../data_words/kevin_tip_2')
    ...
    char_df = data_utils.load_subject('../data_upper/kevin_tip_first')
