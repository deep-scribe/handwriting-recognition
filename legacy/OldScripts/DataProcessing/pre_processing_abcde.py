...
RAW_FILE_NAME_D = 'run_letter_d.csv'
RAW_FILE_NAME_E = 'run_letter_e.csv'

SAVE_FILE_NAME_A = 'run_letter_a_format.csv'
SAVE_FILE_NAME_B = 'run_letter_b_format.csv'
SAVE_FILE_NAME_C = 'run_letter_c_format.csv'
SAVE_FILE_NAME_D = 'run_letter_d_format.csv'
SAVE_FILE_NAME_E = 'run_letter_e_format.csv'
...
def render_output(raw_data_list, output_file_name):
    writer = csv.writer(open(output_file_name, 'w', encoding='utf-8'))
    ...
    for sample_index in range(1, max_list_index + 1):
        ...
        # we also want to remove the special char from the list
        target_raw_sample[0][0] = target_raw_sample[0][0].replace(u'\ufeff', '')
...
def main():
    ...
    print('reading raw input on letter d')
    raw_list_d = read_raw_input(RAW_FILE_NAME_D)
    print('reading raw input on letter e')
    raw_list_e = read_raw_input(RAW_FILE_NAME_E)
    ...
    print('saving rendered output on letter d')
    render_output(raw_list_d, SAVE_FILE_NAME_D)
    print('saving rendered output on letter e')
    render_output(raw_list_e, SAVE_FILE_NAME_E)
